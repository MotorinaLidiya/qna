...
RSpec.describe Reaction, type: :model do
  ...
  it 'validates uniqueness of user reaction' do
    create(:reaction, user: user, reactionable: question, kind: :like)

    new_reaction = build(:reaction, user: user, reactionable: question, kind: :dislike)
  ...
  it 'does not allow a user to react on his own content' do
    reaction = build(:reaction, user: another_user, reactionable: question, kind: :like)
  ...
  it 'is valid when a user reacts on someone else content' do
    reaction = build(:reaction, user: user, reactionable: question, kind: :like)
